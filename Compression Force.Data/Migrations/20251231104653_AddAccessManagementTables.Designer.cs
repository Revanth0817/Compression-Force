...
namespace Compression_Force.Data.Migrations
{
    ...
    [Migration("20251231104653_AddAccessManagementTables")]
    partial class AddAccessManagementTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Compression_Force.Domain.Entities.SecuritySetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Compression_Force.Domain.Entities.UserAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Compression_Force.Domain.Entities.UserPrivilege", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("SignalMonitoring")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Compression_Force.Domain.Entities.UserAccess", b =>
                {
                    b.HasOne("Compression_Force.Domain.Entities.UserManagement", "User")
                        .WithMany()
