...
public partial class ResultEjectLoadS1B
{
    ...
    public long? Revolution { get; set; }
    ...
    public double? S1FeederSpeed { get; set; }

    public double? S2FeederSpeed { get; set; }

    public double? SrelValue { get; set; }
}
